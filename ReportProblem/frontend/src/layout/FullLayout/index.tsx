...
import Paymentpages from "../../pages/PaymentConfirmation";
import DormBookingpages from "../../pages/dorm";
import Personal from "../../pages/personal";
import Listpages from "../../pages/list";
import Repairpages from "../../pages/Repairing";
import DelayedPaymentpages from "../../pages/DelayedPaymentForm";
import EnExitingpages from "../../pages/En_ExitingForm";
import Resigningpages from "../../pages/ResigningForm";
