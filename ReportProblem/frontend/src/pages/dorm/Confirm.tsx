...
function Confirm() {
  return (
    <>
      ...
      <div className='flex'>
        <div className='text-3'>หอพัก 3</div>
        <div className='text-2'>หอพัก 4</div>
      </div>
      <div className='container'>
        <div className='background'>
          <div className='grid'>
            <div className='item-1'>ชั้น 1</div>
            <Link to="/Bsub"><div className='item-2'>
              <div>4100</div><br/><div>จองแล้ว</div><div>1/3</div>
            </div></Link>
            <Link to="/Bsub"><div className='item'>
            ...
            <div className='item-1'>ชั้น 2</div>
            <Link to="/Bsub"><div className='item'>
            ...
            <div className='item-1'>ชั้น 3</div>
            <Link to="/Bsub"><div className='item'>
